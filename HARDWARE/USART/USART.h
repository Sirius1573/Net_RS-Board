...
extern uint8_t WIFI_UpLineFlag;
extern _Bool WIFI_CommandFlag;
extern uint16_t rx2_cnt;
extern uint8_t rx2_buf[1024];
extern uint16_t rx3_cnt;
extern uint8_t rx3_buf[1024];
extern uint16_t rx4_cnt;
extern uint8_t rx4_buf[1024];
