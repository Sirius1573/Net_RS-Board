...
extern unsigned char S0_Port[2];	//端口0的端口号
extern unsigned char S0_DIP[4];		//端口0目的IP地址 
extern unsigned char S0_DPort[2];	//端口0目的端口号
...
void W5500_Socket_Set(void);//端口初始化配置
void Process_Socket_Data(SOCKET s);//处理接收的数据
